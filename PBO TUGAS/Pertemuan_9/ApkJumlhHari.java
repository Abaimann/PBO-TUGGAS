...
public class ApkJumlhHari extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bulanCB.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHitungActionPerformed
        ...
        NgitungHari hitunghari = new NgitungHari();
        String getHitung =  hitunghari.Hitung(tahunTF.getText(),(bulanCB.getSelectedItem().toString()));
        jLabel3.setText(getHitung);
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
        try {
            File currentDirectory = new File(ApkJumlhHari.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile();
            ...
            try (FileWriter writer = new FileWriter(targetFile)) {
                writer.write("Tahun\t: "+tahunTF.getText()+"\n");
                writer.write("Bulan\t: "+bulanCB.getSelectedItem().toString()+"\n");
                writer.write(hitunghari.Hitung(tahunTF.getText(),(bulanCB.getSelectedItem().toString())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApkJumlhHari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApkJumlhHari().setVisible(true);
            }
        });
    }
